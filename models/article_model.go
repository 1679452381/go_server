...
type ArticleModel struct {
	...
	TagModels     []TagModel     `gorm:"many2many:article_tag_models;joinForeignKey:article_id;joinReferences:tag_id" json:"-"` //文章标签
	Tags          ctype.Array    `json:"tags"`                                                                                  //文章标签
	CommentModels []CommentModel `gorm:"foreignKey:ArticleID" json:"-"`                                                         //文章评论
	AuthModel     []AuthModel    `gorm:"many2many:auth2_collects_models;" json:"-"`                                             //文章作者
